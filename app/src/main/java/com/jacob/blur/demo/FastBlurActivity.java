...
public class FastBlurActivity extends FragmentActivity {
    ...
    private void blur(Bitmap bmp, TextView textView) {
        long statTime = System.currentTimeMillis();
        int radio = 2;
        float scaleFactor = 8;

        Bitmap overlay = Bitmap.createBitmap(textView.getMeasuredWidth(),
        ...
        overlay = fastblur(overlay,radio);
        textViewBlur.setBackground(new BitmapDrawable(getResources(),overlay));
